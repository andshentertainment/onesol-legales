...
Al descargar, instalar o utilizar de cualquier forma la Aplicación, usted, el usuario, declara haber leído, entendido y aceptado íntegramente estos Términos, así como la Política de Privacidad. Si no está de acuerdo con alguno de estos Términos, deberá abstenerse de usar la Aplicación.

2. Definiciones

Aplicación: el software móvil "1 Sol", disponible para dispositivos Android (y plataformas compatibles), incluyendo todas sus funcionalidades, contenidos y actualizaciones.
...
Modos de Juego: las distintas formas de interactuar con la Aplicación (actualmente "Historia", "Sin fin" y "Contrarreloj"), cada una con su propio contador y progreso independiente entre sí, almacenados localmente conforme a la sección 7.

3. Descripción del Servicio y Naturaleza de la Aplicación
"1 Sol" es una aplicación estrictamente de entretenimiento, colección digital y novedad. Su funcionalidad principal consiste en interactuar de forma táctil con la representación visual de una moneda, llevando un conteo de dichas interacciones. La Aplicación ofrece distintos Modos de Juego, con sus propias reglas, contadores y progreso, todos independientes entre sí.
La Aplicación no constituye una billetera digital, plataforma financiera, sistema de inversión, ni un medio de pago.
...
5.7 Contenido de Objetivo (monedas desbloqueadas por progreso)
El Contenido de Objetivo no es una Compra Integrada: se desbloquea automáticamente al alcanzar, dentro del modo "Historia", el número de vueltas completadas que la Aplicación indique para cada moneda. No requiere pago alguno, no genera cargo a la cuenta de Google Play del Usuario y no está sujeto a reembolso, ya que no existe transacción económica de por medio. Una vez desbloqueado, el Contenido de Objetivo queda disponible de forma permanente en el dispositivo y no se pierde al reiniciar el progreso de una vuelta en curso; solo podría perderse si el Usuario desinstala la Aplicación o borra sus datos locales conforme a la sección 7.

6. Uso de la Cuenta de Google Play y Compras No Autorizadas
El Usuario es responsable de la seguridad de su cuenta de Google Play y de mantener activados los controles de autenticación de compras (por ejemplo, huella dactilar, PIN o contraseña) provistos por Google Play Store, así como los controles parentales aplicables cuando el dispositivo sea utilizado por menores de edad.
El Titular no será responsable por compras realizadas sin la autorización del titular de la cuenta de Google Play, incluyendo aquellas efectuadas por menores de edad o por terceros con acceso al dispositivo o a la cuenta; dichas reclamaciones deberán dirigirse exclusivamente a Google Play, conforme a su propia política de reembolsos y controles de seguridad.

7. Privacidad y Almacenamiento de Datos
Todo el progreso del Usuario se almacena localmente en el dispositivo, de forma independiente para cada Modo de Juego. Esto incluye, según el modo: el contador de interacciones en curso, las vueltas completadas, las monedas desbloqueadas (tanto Compras Integradas como Contenido de Objetivo), la moneda y el tema visual seleccionados, y los récords personales del modo "Contrarreloj". La Aplicación no recopila, transmite ni almacena datos personales en servidores externos o bases de datos en la nube; toda esta información permanece exclusivamente en el dispositivo del Usuario, salvo el uso transitorio descrito en la sección 5.2 para procesar las Compras Integradas.

8. Propiedad intelectual
Todos los derechos de propiedad intelectual sobre el código fuente, interfaz, logotipos y elementos originales de software de la Aplicación pertenecen al Titular. Se concede al Usuario una licencia limitada para el uso personal y no comercial de la Aplicación. Queda prohibida la reproducción, distribución o ingeniería inversa de la Aplicación.

9. Limitación de responsabilidad
La Aplicación se ofrece "tal cual" y "según disponibilidad". En la máxima medida permitida por la ley aplicable, el Titular no será responsable por daños indirectos, incidentales o consecuentes derivados del uso o la imposibilidad de uso de la Aplicación.

10. Modificaciones al Servicio y a los Términos
El Titular se reserva el derecho de modificar o actualizar la Aplicación y estos Términos en cualquier momento. El uso continuado tras la publicación de cambios implica la aceptación de los nuevos Términos.

11. Ley aplicable y jurisdicción
Estos Términos se rigen por las leyes de la República del Perú. Para cualquier controversia, las partes se someten a la jurisdicción de los jueces y tribunales de la ciudad de Huancayo, Junín, Perú.

12. Contacto
Para consultas o solicitudes relacionadas con estos Términos, el Usuario puede contactar al Titular a través del correo electrónico: soporte.andsh@gmail.com.
